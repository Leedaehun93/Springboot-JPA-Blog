 ...
 * @Data : 자바 클래스에 대해 자주 사용되는 메소드들을 자동으로 생성해주는 역할로 아래 생략 어노ㅔ이션을 자동 생략할 수 있게 자동 제공하여 가독성을 높임
 ...
 * @Builder : 객체를 단계적으로 생성할 수 있는 빌더 패턴을 간단하게 구현하는 어노테이션
 * ======================================
 */
// TODO: Lombok 라이브러리
@Data // TODO: 자바 클래스에 대해 자주 사용되는 메소드들을 자동으로 생성해주는 역할로 아래 생략 어노테이션을 자동 제공하여 가독성을 높임
...
public class Member {
    ...
    // TODO: 2) 생성자 정의
//    @Builder // TODO: 빌더 패턴은 객체 생성을 위한 디자인 패턴으로
